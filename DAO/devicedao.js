...
var devicedao={
    ...
    sqlInsertAi: "insert into ai_tbl (Device, Status) values (?,?);",
    ...
    sqlUpdateTon: "update devicetable set Status = 'On' where ID = 3;",
    sqlUpdateToff: "update devicetable set Status = 'Off' where ID = 3;",
